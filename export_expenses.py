...
# -*- coding: utf-8 -*-
"""
Скрипт для экспорта всех расходов из базы данных в текстовый файл
"""
...
def export_all_expenses(db_name="expenses.db", output_file="all_expenses.txt"):
    """
    Экспортирует все расходы из базы данных в текстовый файл
    """
    conn = sqlite3.connect(db_name)
    cursor = conn.cursor()
    
    # Получаем все расходы из всех чатов, отсортированные по дате
    cursor.execute("""
    ...
    # Получаем уникальные chat_id для группировки
